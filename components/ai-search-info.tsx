    ...
    <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 mb-6 border border-[#d4af37]/20">
      ...
      <Accordion type="single" collapsible className="mb-4">
        <AccordionItem value="how-it-works">
          <AccordionTrigger className="text-[#1a5e63]">
            How It Works
          </AccordionTrigger>
          <AccordionContent className="text-[#555]">
            <p className="mb-2">
              Our AI search uses advanced language models to understand the
              meaning behind your query and find relevant verses in the Quran.
            </p>
            <p className="mb-2">
              Unlike traditional search that looks for exact words, AI search
              understands concepts and can find verses that relate to your topic
        ...
        <AccordionItem value="example-searches">
          ...
          <AccordionContent>
            <ul className="space-y-2 text-[#555]">
              <li>
                • <span className="font-medium">Patience</span> - Find verses
              ...
              <li>
                ...
                Guidance on facing difficulties
              </li>
              <li>
                • <span className="font-medium">Gratitude</span> - Verses about
                being thankful to Allah
              </li>
              <li>
                • <span className="font-medium">Knowledge</span> - Verses about
                seeking knowledge
              </li>
            </ul>
            <p className="mt-3 text-sm bg-[#1a5e63]/10 p-2 rounded">
              Results include Arabic text, English translation, and Bengali
        ...
        <AccordionItem value="tips">
          ...
          <AccordionContent className="text-[#555]">
            <ul className="space-y-2">
              ...
              <li>
                • Search for concepts rather than specific words for better
                results
              </li>
              <li>
                • Remember that results are AI-generated and may not be perfect
              </li>
            </ul>
          </AccordionContent>
        </AccordionItem>
      ...
      <div className="flex justify-center">
        <Button
          className="bg-[#d4af37] hover:bg-[#c9a431] text-[#1a5e63]"
          onClick={openSearch}
        >
