      ...
      <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/80 mb-2">
                  Al-Quran is a web application designed to help Muslims read,
                  study, and listen to the Holy Quran.
                </p>
        ...
        <div className="mt-8 pt-4 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="text-sm text-white/80">Al-Quran • The Noble Quran</p>
